...
void sensorarrayAppRun(void)
{
    ...
    if (skipFdcInit) {
        ...
        if (singleCapFdcMode) {
            ...
            s_state.fdcPrimary.refClockQuality = diag.refClockQuality;
            s_state.fdcPrimary.refClockIsCalibrated = diag.refClockIsCalibrated;
            s_state.fdcPrimary.refClockHz = diag.refClockHz;
            s_state.fdcPrimary.refClockHzNominal = diag.refClockHzNominal;
            s_state.fdcPrimary.refClockHzCalibrated = diag.refClockHzCalibrated;
            s_state.fdcPrimary.channel0ClockDividersRaw = diag.channel0ClockDividersRaw;
            s_state.fdcPrimary.channel0ClockDividerValid = diag.channel0ClockDividerValid;
            s_state.fdcPrimary.channel0ClockDividerInfo = diag.channel0ClockDividerInfo;
